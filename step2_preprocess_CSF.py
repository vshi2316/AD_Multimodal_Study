...
strem2_pgrn_core.rename(columns={
    "WU_STREM2CORRECTED": "STREM2",
    "MSD_PGRNCORRECTED": "PGRN"
}, inplace=True)
...
for feat in feature_cols:
    ...
    merge_final[feat] = merge_final[feat] - batch_mean
...
for feat in feature_cols:
    merge_final[feat] = merge_final.groupby("PTID")[feat].transform(
